...
def Generate(Machine_Name, Mode) :
  ...
  log('ProUI Marlin Configurations Generator')
  log('Created by xXHenneBXx\n')
  log('Original Configurator By MRiscoC (c) 2022\n')
