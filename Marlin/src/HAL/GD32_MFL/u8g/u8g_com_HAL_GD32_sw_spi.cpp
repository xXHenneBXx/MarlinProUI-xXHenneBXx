...
#warning "Software SPI for U8Glib is experimental on GD32F303RE. Please share your experiences at https://github.com/xXHenneBXx
...
uint8_t u8g_com_HAL_GD32_sw_spi_fn(u8g_t *u8g, uint8_t msg, uint8_t arg_val, void *arg_ptr) {
  switch (msg) {
