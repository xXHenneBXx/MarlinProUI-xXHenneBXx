...
#if ENABLED(USE_STOCK_DWIN_SET)
  
  /// TODO: Test a Method of sending images to screen directly into internal ram/flash to be saved.
  /// Vice versa, store images into internal MCU flash/ram and send through serial to be render onto screen
  /// If we cn send gcodes and commands, why not images ? Complete bypassing any need to recreate firmware!
  // Stock Icon Set For Use With TJC DISPLAYS & some Extensible UI's
  #define ICON 9 // Stock Icon Set 9, Baked into TJC Firmware .tft
  #define ICON_LOGO                0
