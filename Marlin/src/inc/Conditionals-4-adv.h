...
#if ENABLED(ADAPTIVE_STEP_SMOOTHING) && ENABLED(DWIN_LCD_PROUI)
#elif ENABLED(ADAPTIVE_STEP_SMOOTHING) && ENABLED(TJC_DISPLAY)
 ...
 */
  ...
  #elif MB(CREALITY_V24S1_301, CREALITY_V24S1_301F4, CREALITY_F401RE, CREALITY_V423, CREALITY_CR4NTXXC10, CREALITY_CR4NS, MKS_ROBIN, PANOWIN_CUTLASS, KODAMA_BARDO, CREALITY_V4, CREALITY_V422_GD32_MFL, CREALITY_V427_GD32_MFL)
