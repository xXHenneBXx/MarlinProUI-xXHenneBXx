 ...
 */
   ...
   */
  //#define THERMAL_PROTECTION_VARIANCE_MONITOR  // Improved Marlin 2.1 thermal monitoring, Disable if you continue to get false readings  // MRiscoC disabled because it gives false positives
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_PROGRESS_PERCENT           // Show print progress percentage (doesn't affect progress bar)  // Show print progress percentage
  ...
  #define EVENT_GCODE_SD_ABORT "G28XY"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")  // G-code to run on SD abort
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_FOLDERS        -1      // -1=above  0=none  1=below  // Sort folders above files (-1=above, 0=none, 1=below)
   ...
   */
  #define SD_ABORT_ON_ENDSTOP_HIT  // Abort SD print on endstop hit
...
//
#if HAS_DGUS_LCD
  #define LCD_BAUDRATE 250000  // LCD_BAUDRATE 
 ...
 */
#define LCD_BACKLIGHT_TIMEOUT_MINS 5  // (minutes) Timeout before turning off the backlight  // Uncomment before setting value
...
#define BABYSTEPPING  // Ender Configs
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28  // Display total babysteps since last G28

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping  // Allows live Z offset adjustment
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    //#define BABYSTEP_GFX_OVERLAY          // Enable graphical overlay on Z-offset editor  // Shows Z offset adjustment overlay / Graphical LCD's Only
  #endif
#endif
 ...
 */
  ...
  #define MESH_MAX_X X_BED_SIZE - (MESH_INSET) - (MESH_INSET)
  #define MESH_MAX_Y Y_BED_SIZE - (MESH_INSET) - (MESH_INSET)
#endif
...
#define FWRETRACT  // MRiscoC Enabled support for firmware based retract
  ...
  #endif
  #define RETRACT_LENGTH                5   // (mm) Default retract length (positive value)  // Default retract  // Bowden
...
#define ADVANCED_PAUSE_FEATURE  // MRiscoC Enabled
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     0  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  #define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.  // Improved filament change purge
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below)  // xXHenneBXx Correct value for UART mode drivers
 ...
 */
#define M114_DETAIL         // Use 'M114 D' for details to check planner calculations  // Detailed position reporting
#define M114_REALTIME       // Real current position based on forward kinematics  // Realtime position reporting
 ...
 */
#define AUTO_REPORT_TEMPERATURES  // Automatic temperature reporting
 ...
 */
#define AUTO_REPORT_POSITION  // Automatic position reporting
...
#define FASTER_GCODE_PARSER
  ...
  #define GCODE_QUOTED_STRINGS  // Support for quoted string parameters  // Required by PROUI custom G-code support
#endif
...
#define HOST_ACTION_COMMANDS  // MRiscoC Enabled actions from host
  ...
  #define HOST_PROMPT_SUPPORT             // Initiate host prompts to get user feedback  // MRiscoC Enabled responses from host
    ...
    #define HOST_STATUS_NOTIFICATIONS     // Send some status messages to the host as notifications  // Host status updates
  #endif
