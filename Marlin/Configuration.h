...
#define STRING_CONFIG_H_AUTHOR "xXHenneBXx" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Henne"
...
//#define CLASSIC_JERK  // Enable JUNCTION DEVIATION
  ...
  #define DEFAULT_EJERK  5.0  // Steady extrusion jerk
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   3 // (mm) Z Clearance for Deploy/Stow  // MRiscoC AutoLev from Substancia3D
#define Z_CLEARANCE_BETWEEN_PROBES  2 // (mm) Z Clearance between probe points  // MRiscoC AutoLev from Substancia3D
#define Z_CLEARANCE_MULTI_PROBE     2 // (mm) Z Clearance between multiple probes  // AutoLev from Substancia3D
#define Z_PROBE_ERROR_TOLERANCE     3 // (mm) Tolerance for early trigger (<= -probe.offset.z + ZPET)
//#define Z_AFTER_PROBING           5 // (mm) Z position after probing is done

#define Z_PROBE_LOW_POINT          -2 // (mm) Farthest distance below the trigger-point to go before stopping  // MRiscoC AutoLev from Substancia3D
...
#define FILAMENT_RUNOUT_SENSOR  // MRiscoC Enabled runout sensor support
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 25  // Ender Configs  // Ender Configs  // Customizable by menu
...
//#define AUTO_BED_LEVELING_BILINEAR  // MRiscoC AutoLev auto level  // Disabled for UBL
#define AUTO_BED_LEVELING_UBL  // Required by PROUI_EX  // MRiscoC UBL
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION  // UBL mesh validation pattern
  ...
  #define GRID_MAX_POINTS_X 5  // xXHenneBXx: must uncomment before CustomVal can set it, or GRID_MAX_POINTS_Y (which references it) breaks the build  // MRiscoC Customizable by menu
  ...
  #define GRID_MAX_POINTS_X 5      // Don't use more than 15 points per axis, implementation limited.  // xXHenneBXx: must uncomment before CustomVal can set it, or GRID_MAX_POINTS_Y (which references it) breaks the build  // MRiscoC Customizable by menu
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
  ...
  //#define UBL_SAVE_ACTIVE_ON_M500   // Save the currently active mesh in the current slot on M500  // Save active UBL mesh with EEPROM  // Disabled for AML compatibility

  #define UBL_Z_RAISE_WHEN_OFF_MESH 2.5 // When the nozzle is off the mesh, this value is used  // Raise Z outside valid mesh area  // Raise Z outside valid mesh area
 ...
 */
#define Z_SAFE_HOMING  // Required for Marlin builds  // MRiscoC Homing Z at center of bed
...
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save flash.  // EEPROM feedback messages
...
//
#define HOST_KEEPALIVE_FEATURE        // Disable this if your host doesn't like keepalive messages  // Improved host communication
...
//
#define ENCODER_PULSES_PER_STEP 4  // Ender Configs  // Ender Configs

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
#define ENCODER_STEPS_PER_MENU_ITEM 1  // Ender Configs  // Ender Configs
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 50  // Uncomment before setting value  // Ender Configs
#define LCD_FEEDBACK_FREQUENCY_HZ 800  // Uncomment before setting value  // Ender Configs
