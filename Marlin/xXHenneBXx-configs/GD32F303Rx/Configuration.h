...
#define STRING_CONFIG_H_AUTHOR "xXHenneBXx"
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_CREALITY_V422_GD32_MFL // BOARD_CREALITY_V427 BOARD_VOXELAB_AQUILA BOARD_CREALITY_V4  BOARD_CREALITY_V422_GD32_MFL BOARD_CREALITY_CR4NS
#endif
 ...
 */
#define BAUDRATE 250000 // Increase to 250000
...
#define CUSTOM_MACHINE_NAME "xXHenneBXx"
 ...
 */
#define TEMP_SENSOR_0 1  // 100k EPCOS Standard
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 112.83
  #define DEFAULT_BED_KI  21.05
  #define DEFAULT_BED_KD 403.18
...
// @section pid temp
  ...
  #define PID_EDIT_MENU         // Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash)  // Ender Configs  // Ender Configs
  #define PID_AUTOTUNE_MENU     // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash)  // Ender Configs  // Ender Configs
#endif
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2  // MRiscoC allows higher limits  // MRiscoC allows higher limits
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES { 3000, 3000, 80, 200 }  // MRiscoC allows higher limits
#endif
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2  // MRiscoC allows higher limits  // MRiscoC allows higher limits
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES { 9999, 9999, 999, 9999 }  // MRiscoC allows higher limits
#endif
 ...
 */
#define DEFAULT_ACCELERATION 500  // Ender Configs
#define DEFAULT_RETRACT_ACCELERATION 800  // Ender Configs
#define DEFAULT_TRAVEL_ACCELERATION 1000  // Ender Configs
...
#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2  // Ender Configs  // Ender Configs
  #if ENABLED(LIMITED_JERK_EDITING)
    #define MAX_JERK_EDIT_VALUES { 20, 20, 1, 20 }  // MRiscoC allows higher limits
  #endif
#endif
 ...
 */
//#define Z_MIN_PROBE_PIN -1  // Pin 32 is the RAMPS default
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE 5  // MRiscoC Increase speed
#define Z_CLEARANCE_BETWEEN_PROBES 5  // MRiscoC Increase probe compatibility
#define Z_CLEARANCE_MULTI_PROBE 5  // MRiscoC Increase speed
#define Z_PROBE_ERROR_TOLERANCE     3 // (mm) Tolerance for early trigger (<= -probe.offset.z + ZPET)
//#define Z_AFTER_PROBING           5 // (mm) Z position after probing is done

#define Z_PROBE_LOW_POINT -3  // MRiscoC allows reach lower points

// For M851 provide ranges for adjusting the X, Y, and Z probe offsets
//#define PROBE_OFFSET_XMIN -100  // MRiscoC increase compatibility with some extruder/probe combinations
//#define PROBE_OFFSET_XMAX 100  // MRiscoC increase compatibility with some extruder/probe combinations
//#define PROBE_OFFSET_YMIN -100  // MRiscoC increase compatibility with some extruder/probe combinations
//#define PROBE_OFFSET_YMAX 100  // MRiscoC increase compatibility with some extruder/probe combinations
...
//#define DELAY_BEFORE_PROBING 200  // MRiscoC Wait for stability
...
#define X_BED_SIZE 235  // Max usable bed size
#define Y_BED_SIZE 235  // Max usable bed size

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -5  // Stock physical limit
#define Y_MIN_POS -5  // Stock physical limit
#define Z_MIN_POS 0
 ...
 */
#define FILAMENT_RUNOUT_SENSOR  // MRiscoC Enabled runout sensor support  // MRiscoC Enabled runout sensor support
 ...
 */
#define PREHEAT_BEFORE_LEVELING  // MRiscoC Heatting to compensate thermal expansions  // MRiscoC Heatting to compensate thermal expansions
#if ENABLED(PREHEAT_BEFORE_LEVELING)
  #define LEVELING_NOZZLE_TEMP   0  // MRiscoC No necessary for BLTouch
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  //#define G26_MESH_VALIDATION  // UBL mesh validation pattern  // UBL mesh validation pattern
  ...
  #define GRID_MAX_POINTS_X 5  // MAX IS 9
  ...
  // #define UBL_SAVE_ACTIVE_ON_M500  // Disabled for AML compatibility

  #define UBL_Z_RAISE_WHEN_OFF_MESH 2.5  // Raise Z outside valid mesh area
...
#define LCD_BED_TRAMMING  // ProUI has a bed tramming menu  // ProUI has a bed tramming menu
  ...
  #define BED_TRAMMING_USE_PROBE  // Use a probe if it is available  // Use a probe if it is available
  #if ENABLED(BED_TRAMMING_USE_PROBE)
    #define BED_TRAMMING_PROBE_TOLERANCE 0.05  // ProUI bed tramming wizard tolerance
 ...
 */
#define Z_SAFE_HOMING  // Required for Marlin builds  // Required for Marlin builds  // MRiscoC Homing Z at center of bed  // MRiscoC Homing Z at center of bed
...
#define EDITABLE_HOMING_FEEDRATE  // MRiscoC Homing editable speed  // MRiscoC Homing editable speed
...
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save flash.  // EEPROM feedback messages  // EEPROM feedback messages
//#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  #define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors.  // Ender Configs  // Ender Configs
  #define EEPROM_INIT_NOW   // Init EEPROM on first boot after a new build.  // MRiscoC Reset EEPROM on first boot  // MRiscoC Reset EEPROM on first boot
#endif
...
//
#define HOST_KEEPALIVE_FEATURE        // Disable this if your host doesn't like keepalive messages  // Improved host communication  // Improved host communication
...
//
#define PREHEAT_1_LABEL "PLA"  // PLA preheat preset
#define PREHEAT_1_TEMP_HOTEND 195
#define PREHEAT_1_TEMP_BED 60
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED 128

#define PREHEAT_2_LABEL "ABS"  // ABS preheat preset
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_Z_RAISE_MIN 0  // MRiscoC uses Park Z Raise from 0 to avoid backlash issues
 ...
 */
#define NOZZLE_CLEAN_FEATURE  // Nozzle cleaning routine
...
#define TJC_DISPLAY
  ...
  #define USE_STOCK_DWIN_SET 1
#endif

#define ProUI
#if ENABLED(ProUI)  // Professional firmware features:	
  #if ENABLED(FILAMENT_RUNOUT_SENSOR)
