 ...
 */
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD 40  // Ender Configs
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD 180  // Ender Configs
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // (°C)

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD 180  // Ender Configs
...
//#define PREHEAT_TIME_BED_MS 7500
 ...
 */
#define HOTEND_IDLE_TIMEOUT  // MRiscoC Disable heaters after timeout  // MRiscoC Disable heaters after timeout
#if ENABLED(HOTEND_IDLE_TIMEOUT)
  #define HOTEND_IDLE_TIMEOUT_SEC (10*60)  // MRiscoC 10 minutes for heaters timeout
  #define HOTEND_IDLE_MIN_TRIGGER (EXTRUDE_MINTEMP - 10)  // MRiscoC set idle trigger lower than default EXTRUDE_MINTEMP
...
#define QUICK_HOME                          // If G28 contains XY do a diagonal move first  // Ender Configs  // Ender Configs
...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_10X_STEPS_PER_SEC 80  // Ender Configs
  #define ENCODER_100X_STEPS_PER_SEC 130  // Ender Configs
#endif
...
#define HAS_DISPLAY 1
  ...
  #define SOUND_MENU_ITEM   // Add a mute option to the LCD menu  // MRiscoC Enable Sound Menu Item  // MRiscoC Enable Sound Menu Item
  ...
  #define STATUS_MESSAGE_SCROLLING  // MRiscoC, Allows scrolling of large status messages  // MRiscoC, Allows scrolling of large status messages

  // Apply a timeout to low-priority status messages
  //#define STATUS_MESSAGE_TIMEOUT_SEC 90  // MRiscoC Enable Status Message Timeout
...
#if ANY(HAS_MARLINUI_MENU, DWIN_CREALITY_LCD, DWIN_LCD_PROUI, MALYAN_LCD, TOUCH_SCREEN, ULTIPANEL_FEEDMULTIPLY, TJC_DISPLAY)
...
#endif
#if ANY(HAS_MARLINUI_MENU, DWIN_CREALITY_LCD, DWIN_LCD_PROUI, MALYAN_LCD, TOUCH_SCREEN, TJC_DISPLAY)
...
#define SET_PROGRESS_MANUALLY  // MRiscoC, Allows display feedback of host printing through GCode M73  // MRiscoC, Allows display feedback of host printing through GCode M73
#if ENABLED(SET_PROGRESS_MANUALLY)
  #define SET_PROGRESS_PERCENT            // Add 'P' parameter to set percentage done  // MRiscoC, Allows display feedback of host printing through GCode M73  // MRiscoC, Allows display feedback of host printing through GCode M73
  #define SET_REMAINING_TIME              // Add 'R' parameter to set remaining time  // MRiscoC, Allows display feedback of host printing through GCode M73  // MRiscoC, Allows display feedback of host printing through GCode M73
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_PROGRESS_PERCENT           // Show print progress percentage (doesn't affect progress bar)  // Show print progress percentage  // Show print progress percentage
  #define SHOW_ELAPSED_TIME               // Display elapsed printing time (prefix 'E')
  #define SHOW_REMAINING_TIME           // Display estimated time to completion (prefix 'R')  // MRiscoC, Allows display remaining printing time  // MRiscoC, Allows display remaining printing time
...
#define HAS_MEDIA 1
  ...
  // #define SD_PROCEDURE_DEPTH  // MRiscoC save program memory
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY  // Ender Configs  // Ender Configs
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_LIMIT 50  // MRiscoC Increase number of sorted items
    #define SDSORT_FOLDERS -1  // Sort folders above files (-1=above, 0=none, 1=below)
    #define SDSORT_GCODE true  // MRiscoC Allows disable file sort by M34 g-code
    #define SDSORT_USES_STACK      false  // Prefer the stack for pre-sorting to give back some SRAM. (Negated by next 2 options.)
    #define SDSORT_USES_RAM true  // Ender Configs
    #if ENABLED(SDSORT_USES_RAM)
      #define SDSORT_CACHE_NAMES true  // Ender Configs
      #if ENABLED(SDSORT_CACHE_NAMES)
        #define SDSORT_DYNAMIC_RAM true  // Ender Configs
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'  // MRiscoC Enabled  // MRiscoC Enabled
  #define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol  // MRiscoC Enabled  // MRiscoC Enabled
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES         // Scroll long filenames in the SD card menu  // MRiscoC Enabled  // MRiscoC Enabled
   ...
   */
  #define SD_ABORT_ON_ENDSTOP_HIT  // Abort SD print on endstop hit  // Abort SD print on endstop hit
  ...
  //#define BINARY_FILE_TRANSFER  // MRiscoC Enabled for easy firmware upgrade  // MRiscoC Enabled for easy firmware upgrade

  #if ENABLED(BINARY_FILE_TRANSFER)
    // Include extra facilities (e.g., 'M20 F') supporting firmware upload via BINARY_FILE_TRANSFER
    //#define CUSTOM_FIRMWARE_UPLOAD  // MRiscoC Enabled for easy firmware upgrade  // MRiscoC Enabled for easy firmware upgrade
  #endif
 ...
 */
#define NO_SD_HOST_DRIVE   // Disable SD Card access over USB (for security).  // Ender Configs  // Ender Configs
 ...
 */
//#define LCD_BACKLIGHT_TIMEOUT_MINS 5
 ...
 */
#define BABYSTEPPING  // Ender Configs  // Ender Configs
#if ENABLED(BABYSTEPPING)
  //#define EP_BABYSTEPPING                 // M293/M294 babystepping with EMERGENCY_PARSER support
  #define BABYSTEP_WITHOUT_HOMING  // MRiscoC Enabled BbS without home  // MRiscoC Enabled BbS without home
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement)  // MRiscoC Active BbS always  // MRiscoC Active BbS always
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28  // Display total babysteps since last G28  // Display total babysteps since last G28

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping  // Allows live Z offset adjustment  // Allows live Z offset adjustment
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    // #define BABYSTEP_GFX_OVERLAY  // Shows Z offset adjustment overlay / Graphical LCD's Only
  #endif
#endif
...
#define ARC_SUPPORT                   // Requires ~3226 bytes
  ...
  #define ARC_P_CIRCLES             // Enable the 'P' parameter to specify complete circles  // MRiscoC Enabled  // MRiscoC Enabled
#endif
 ...
 */
// #define DIRECT_STEPPING  // Klipper Similar
 ...
 */
#define TX_BUFFER_SIZE 256  // MRiscoC Increase buffer for Octoprint
 ...
 */
//#define EMERGENCY_PARSER  // MRiscoC Enabled instantaneous response to emergency commands  // MRiscoC Enabled instantaneous response to emergency commands
...
#define ADVANCED_OK  // MRiscoC better management of buffer by host  // MRiscoC better management of buffer by host
 ...
 */
//#define FWRETRACT  // MRiscoC Enabled support for firmware based retract  // MRiscoC Enabled support for firmware based retract
#if ENABLED(FWRETRACT)
  // #define FWRETRACT_AUTORETRACT  // MRiscoC use slicer retract
  #if ENABLED(FWRETRACT_AUTORETRACT)
    #define MIN_AUTORETRACT             0.1 // (mm) Don't convert E moves under this length
    #define MAX_AUTORETRACT            10.0 // (mm) Don't convert E moves over this length
  #endif
  #define RETRACT_LENGTH 5  // Bowden
  #define RETRACT_LENGTH_SWAP          13   // (mm) Default swap retract length (positive value)
  #define RETRACT_FEEDRATE 13
  #define RETRACT_ZRAISE 0.2  // MRiscoC Bowden
  #define RETRACT_RECOVER_LENGTH        0   // (mm) Default additional recover length (added to retract length on recover)
  #define RETRACT_RECOVER_LENGTH_SWAP   0   // (mm) Default additional swap recover length (added to retract length on recover from toolchange)
  #define RETRACT_RECOVER_FEEDRATE 13
 ...
 */
#define ADVANCED_PAUSE_FEATURE  // MRiscoC Enabled  // MRiscoC Enabled
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         60  // (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE 20  // MRiscoC Increased filament unload speed
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE 12  // MRiscoC Increased filament load speed
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     0  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  #define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.  // Improved filament change purge  // Improved filament change purge
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change.  // MRiscoC Enabled park head when pause command was issued  // MRiscoC Enabled park head when pause command was issued
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES           // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.  // MRiscoC Enabled load/unload Filament G-codes  // MRiscoC Enabled load/unload Filament G-codes
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V  // MRiscoC Correct value for UART mode drivers
   ...
   */
  #define EDGE_STEPPING  // Ender Configs  // Ender Configs
 ...
 */
#define M114_DETAIL         // Use 'M114 D' for details to check planner calculations  // Detailed position reporting  // Detailed position reporting
#define M114_REALTIME       // Real current position based on forward kinematics  // Realtime position reporting  // Realtime position reporting
 ...
 */
#define AUTO_REPORT_TEMPERATURES  // Automatic temperature reporting  // Automatic temperature reporting
 ...
 */
#define AUTO_REPORT_POSITION  // Automatic position reporting  // Automatic position reporting
...
#define CAPABILITIES_REPORT
  ...
  #define EXTENDED_CAPABILITIES_REPORT
    ...
    #define M115_GEOMETRY_REPORT  // MRiscoC Enabled  // MRiscoC Enabled
  #endif
#endif
 ...
 */
 //#define MEATPACK_ON_SERIAL_PORT_1  // MeatPack compression on serial port 1 for faster file transfer / Best used for Octoprint Eith No SD-Card
 ...
 */
#define NO_WORKSPACE_OFFSETS  // MRiscoC Save flash space and simplify movements  // MRiscoC Save flash space and simplify movements

/**
 * Disable M206 and M428 if you don't need home offsets.
 */
#define NO_HOME_OFFSETS  // MRiscoC Save flash space and simplify movements  // MRiscoC Save flash space and simplify movements
 ...
 */
#define HOST_ACTION_COMMANDS  // MRiscoC Enabled actions from host  // MRiscoC Enabled actions from host
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76                // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT             // Initiate host prompts to get user feedback  // MRiscoC Enabled responses from host  // MRiscoC Enabled responses from host
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS     // Send some status messages to the host as notifications  // Host status updates  // Host status updates
  #endif
 ...
 */
//#define CANCEL_OBJECTS  // MRiscoC Enabled M486 to skip objects  // MRiscoC Enabled M486 to skip objects
